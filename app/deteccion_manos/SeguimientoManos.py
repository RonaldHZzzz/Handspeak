...
#incializamos parametros de manos
class detectormanos():
    ...
    #funcion para encontrar la posision
    def encontrarposicion(self , frame ,
                          ManoNum = 0,
                          dibujarPuntos = True ,
                          dibujarBox = True ,
                          color = []):
        ...
        return [], [], 0    
    #funcion para detectar y dibujar los dedos de de arriba
